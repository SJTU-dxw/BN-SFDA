...
path_name = f'{os.path.basename(args.config)[:-3]}_num_k_{args.num_k}_weight_{args.weight}_klweight_{args.kl_weight}_beta_{beta}_stop_{args.stop_iteration}_rank_{local_rank}_{timestamp}.log'
if args.no_centroid:
...
trainer = TrainerSFDAClassRelation(rank, model_dict, optimizer_dict, source_model_dict, source_optimizer_dict,
                                   ...
                                   beta, args.num_k, args.weight, args.kl_weight, args.stop_iteration,
