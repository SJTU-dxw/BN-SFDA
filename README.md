...
### 3.3 Office-31
``` shell
CUDA_VISIBLE_DEVICES=0,1 python -m torch.distributed.launch --nproc_per_node=2 main.py --config ./configs/sfda_office/class_relation_office31_AaD_ad.py --pretrained_model office/source_only_a.pth --num_k 4 --stop_iteration 0 --simple_mode
